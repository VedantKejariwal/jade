...
//////////////////////////////////////////////////////////////////////////////
    ...
    Network.prototype.load_netlist = function(netlist, options) {
        ...
        netlist.forEach(function (component,i) {
        ...
        netlist.forEach(function (component,i) {
            ...
            if (type in logic_gates) {
                ...
                var inputs = [];
                info[0].forEach(function (cname,j) { inputs.push(connections[cname]); });
                // create a new device
        ...
        Object.entries(network.node_map).forEach(function ([n,node]) { network.node_map[n].finalize(); });
    };
